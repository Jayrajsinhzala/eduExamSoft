<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="StudentLogin.aspx.cs" Inherits="student_StudentLogin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="wrapper">
		...
		<div id="wrappermiddle">
			...
			<asp:LinkButton ID="ForgotLinkBtn" runat="server" >Forgot your Password?</asp:LinkButton>
