...
public partial class studentN_AllResult : System.Web.UI.Page
{
    ...
    {
        int sid = Convert.ToInt32(TxtSName.Text);
        int eid = Convert.ToInt32(TxtEName.Text);
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        Stu_Name_Label.Text = rs.Stu_Name;
        Exam_Name_Label.Text = rs.Exam_Name;
